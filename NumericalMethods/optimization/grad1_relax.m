function [xmin, fmin, gradmin, niter, nfevals, ngevals, reldif_f, reldif_x, alpha] = grad1_relax(f, fgrad, x0, tolf, tolx, maxNiter, alpha0)
% The function minimizes a function by a 1'st order gradient method. The
...
% ngevals: The number of gradient evaluations
