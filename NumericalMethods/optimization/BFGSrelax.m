function [xmin, fmin, gradmin, niter, nfevals, ngevals, reldif_f, reldif_x, alpha] = BFGSrelax(f, fgrad, x0, tolf, tolx, maxNiter, alpha0)
% The function minimizes a function by the BFGS method. The
