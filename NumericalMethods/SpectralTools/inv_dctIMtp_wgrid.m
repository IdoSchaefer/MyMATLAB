function Vt = inv_dctIMtp_wgrid(Vw, t, w, N)
...
% w: a row vector; the omega grid of the frequency points represented by Vw.
% N: The number of points in the frequency grid minus 1 (the 0 frequency is
% not counted), including the points which may not appear in Vw.
% Output:
