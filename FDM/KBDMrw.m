% Intended for a complex input, with real frequencies.
% This file assumes the existance of the variables: c (the signal, t=(-(K-1),-(K-2),...,K)*dt, dt (the time step),
% and K (the number of exponential terms in the line list).
% Maybe there is a mistake; anyway, works very bad.
% Building the c index matrix:
v = ones(1, K);
u = 0:K-1;
minusi = v.'*u - u.'*v;
t0i = K;
