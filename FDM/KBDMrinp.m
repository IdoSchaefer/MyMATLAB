function [wreal, d_result, w_result, g_result, meand, w_maxd, maxd] = KBDMrinp(c, dt, Kre)
% c: the signal, from t=0.
% dt: the time step.
% Kre: the number of real sinusoidal terms in the line list.
szc = size(c);
if szc(1) == 1
    c = c.';
end
