function [U mniter matvecs] = TDHxp_abs(K, V, Vtfun, ihfun, absfun, Edomain, ui, x, tdomain, Nts, Nt_ts, Ncheb, tol, varargin)
...
% absbfun: a function handle of the form: @(x); Represents the absorbing
% boundaries.
...
% matvecs: the number of Hamiltonian operations.
    ...
    for tsi = 1:Nts
        ...
        while (reldif>tol && niter<Niter)
            ...
            % the operator Hts = K + Vts, that opperates on Lambda(:, Nt_ts+1).
