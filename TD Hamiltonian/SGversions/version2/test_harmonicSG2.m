...
data = SGdata(options);
tic
[U, mniter, matvecs, est_errors, history] = SemiGlobal2(@(u, t, v) -1i*Hpsi(K, V + x*cos(t), v), @(u1, t1, u2, t2) -1i*x*(cos(t1) - cos(t2)).*u1, 0, [], [-195*1i, 0], fi0, t, Nts, Nt_ts, Ncheb, tol, options, data);
toc
