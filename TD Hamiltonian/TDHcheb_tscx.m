function U = TDHcheb_tscx(H0, minE0, maxE0, Vt, ui, T, Nts, Nt_ts, Ncheb, tol)
...
% Vt is the time-dependent disturbance. It is a 3D tensor. 
% Intended for the case when Vt is a function of the variable of
% ui; every column represents a time point. The 3'rd index is the time
% step, and the 2'nd is the index of the Chebychev point within the time
