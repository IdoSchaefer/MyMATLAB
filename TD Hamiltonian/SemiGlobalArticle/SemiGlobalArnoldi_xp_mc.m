function [U, mniter, matvecs, max_errors, history] = SemiGlobalArnoldi_xp_mc(K, V, Vtfun, ihfun, ui, x, tgrid, Nts, Nt_ts, Nkr, tol, Niter, Niter1st, display_mode, varargin)
