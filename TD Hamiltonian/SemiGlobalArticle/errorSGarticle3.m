function [allNt, allmv, aller, max_ers] = errorSGarticle3(T, Nt_ts, Nkr, minNt, Nsamp, Niter)
...
for degi = 1:Nsamp
    ...
    Nt = round(10^deg);
    allNt(degi) = Nt;
    [u, ~, matvecs, all_est_er] = SemiGlobalArnoldi_xp_mc(K240, Vabs240, @(u,x,t) -xabs240*0.1*sech((t-500)/(170)).^2.*cos(0.06*(t-500)), [], fi0240, x240, [0 T], Nt, Nt_ts, Nkr, eps, Niter, 20, false);
    allmv(degi) = matvecs;
