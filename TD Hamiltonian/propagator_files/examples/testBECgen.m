% The program demonstrates the application of TDHgeneral,
...
Vt = @(v, u, t, x, K) (x*cos(t) + conj(u).*u).*v;
tic
[U mniter matvecs] = TDHgeneral(@harmonicH0op, Vt, [], [-1 188], gs, [0 T], Nt, Nt_ts, Ncheb, tol, x, Kp);
toc
