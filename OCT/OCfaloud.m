function [fieldt, fieldw, psi, evmiut, evmiuw, relE, conv, niter, mallniterc, J1, maxgrad, weight] = OCfaloud(psi0, Vf, m, Edomain, xdomain, ...
...
%        Jforbfun = -penalforb*evmiuMLS(psi, projforb)*dt;
