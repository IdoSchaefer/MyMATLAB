function [fieldt, fieldw, psi, evmiut, evmiuw, relE, conv, niter, mallniterc, J1, maxgrad, weight] = OCfrlx(psi0, Vf, m, Edomain, xdomain,...
    fguess, filterE, filtermiu, iweight, T, dt, Nt_ts, Ncheb, tol)
