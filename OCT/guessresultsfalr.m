function [fieldt, fieldw, psi, evmiut, evmiuw, mniterc, J, J1, J2, Jorth, Jforb] = guessresultsfalr(psi0, Vf, m, Edomain, xdomain, ...
    miufunx, aloudwf, forbwf, fguess, filterE, filtermiu, ppenal, penalforb, T, dt, Nt_ts, Ncheb, tol)
...
%     maxgrad = max(abs(grad));
    ...
    function getpsi(fieldwint)
        ...
        J1 = sum(J1fun);
        J2 = sum(J2fun);
        Jorth = - 0.5*ppenal*(evpT/m)^2;
        Jforb = - sum(integw.*allevprojforb);
        J = J1 + J2 + Jforb + Jorth;
    end
