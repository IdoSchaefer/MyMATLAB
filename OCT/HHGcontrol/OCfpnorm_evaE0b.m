function [fieldt, fieldw, psi, evat, evaw, evmiut, evmiuw, relE, conv, niter, mallniterc, J1, maxgrad, weight] = OCfpnorm_evaE0b(psi0, Vf, m,...
    xdomain, miux, a0, penalnormf, Dpenalnormf, fguess, filterE, filtera, orthpenal, iweight, T, dt, Nt_ts, Nkr, tol, maxNiter)
