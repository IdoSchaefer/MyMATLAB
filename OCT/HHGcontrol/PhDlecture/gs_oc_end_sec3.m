...
allgsocsec3 = zeros(1, 12);
allfields_psi3_sec = zeros(3, 5001, 12);
for cwi = 1:12
    cw_con_allt_seci = 0.1*cwi*cw_con_allt_sec;
    allpsi3i = solveOCMLSih(@ihfieldMLS, H03, [0 1], miu240_3, [1;0;0], [0 1e3], 5e3, 7, 7, 1e-5, cw_con_allt_seci);
    allfields_psi3_sec(:, 1:5000, cwi) = allpsi3i(:, 1, :);
    allfields_psi3_sec(:, 5001, cwi) = allpsi3i(:, 7, 5000);
end
allgsocsec3(:) = allfields_psi3_sec(1, 5001, :).*conj(allfields_psi3_sec(1, 5001, :));