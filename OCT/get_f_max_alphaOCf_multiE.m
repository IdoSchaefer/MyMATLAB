function f_max_alphaOCf = get_f_max_alphaOCf_multiE(max_fieldt, dt, T, filterE, Ncontrols)
...
% filterE: As in the OCf_qn programs
    ...
    NEnz = length(iEnz);
    f_max_alphaOCf = @(fieldwnz0, direction) alpha_maxOCf_multiE(fieldwnz0, direction, max_fieldt, Nt, iEnz, NEnz, Ncontrols, T);
end