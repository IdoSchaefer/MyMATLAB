function [U, allfield, mniter, matvecs] = solveOCMLSihallf(ihfun, H0, Edomain, miu, ui, tdomain, Nts, Nt_ts, Ncheb, tol, varargin)
...
%        Lambda(:, 1) = U(:, 1, tsi);
        ...
        while (reldif>tol && niter<Niter)
            ...
            [Fi, Hts, allfield(((tsi - 1)*(Nt_ts - 1) + 1):(tsi*(Nt_ts - 1) + 1))] = ihfun(Ulast, miu, tsi, H0, varargin{:});
