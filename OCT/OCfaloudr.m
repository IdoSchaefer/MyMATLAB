function [fieldt, fieldw, psi, evmiut, evmiuw, relE, conv, niter, mallniterc, J1, maxgrad, weight] = OCfaloudr(psi0, Vf, m, Edomain,...
    xdomain, aloudwf, forbwf, fguess, filterE, filtermiu, ppenal, penalforb, iweight, T, dt, Nt_ts, Ncheb, tol)
...
% tol: the tolerance of the optimization process.
    ...
    miualoud = projaloud*spdiags(x, 0, Nx, Nx)*projaloud;
