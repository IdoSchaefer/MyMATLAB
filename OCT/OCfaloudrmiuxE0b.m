function [fieldt, fieldw, psi, evmiut, evmiuw, relE, conv, niter, mallniterc, J1, maxgrad, weight] = OCfaloudrmiuxE0b(psi0, Vf, m, Edomain,...
...
%         newfieldw_unc = dctfactor*dctIfrom_ig(chimiupsi, T, t_ts(1:(Nt_ts - 1)), igweights).*vfilterE;
        newfieldw_unc = dctfactor*dctI(chimiupsi).*vfilterE;
